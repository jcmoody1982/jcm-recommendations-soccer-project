...
public class TeamMapper {
    ...
    public TeamSeasonStats toTeamSeasonStats(TeamDto dto, Long seasonId) {
        ...
        return TeamSeasonStats.builder()
                ...
                .scoredAvgHtOverall(dto.getScoredAvgHtOverall())
                .scoredAvgHtHome(dto.getScoredAvgHtHome())
                .scoredAvgHtAway(dto.getScoredAvgHtAway())
                .concededAvgHtOverall(dto.getConcededAvgHtOverall())
                .concededAvgHtHome(dto.getConcededAvgHtHome())
                .concededAvgHtAway(dto.getConcededAvgHtAway())
                .scoredAvg2hOverall(dto.getScoredAvg2hOverall())
                .scoredAvg2hHome(dto.getScoredAvg2hHome())
                .scoredAvg2hAway(dto.getScoredAvg2hAway())
                .concededAvg2hOverall(dto.getConcededAvg2hOverall())
                .concededAvg2hHome(dto.getConcededAvg2hHome())
                .concededAvg2hAway(dto.getConcededAvg2hAway())
                .bttsFhgPercentageOverall(dto.getBttsFhgPercentageOverall())
                .bttsFhgPercentageHome(dto.getBttsFhgPercentageHome())
                .bttsFhgPercentageAway(dto.getBttsFhgPercentageAway())
                .btts2hgPercentageOverall(dto.getBtts2hgPercentageOverall())
                .btts2hgPercentageHome(dto.getBtts2hgPercentageHome())
                .btts2hgPercentageAway(dto.getBtts2hgPercentageAway())
                .shotsAvgOverall(dto.getShotsAvgOverall())
                .shotsAvgHome(dto.getShotsAvgHome())
                .shotsAvgAway(dto.getShotsAvgAway())
                .foulsAvgOverall(dto.getFoulsAvgOverall())
                .foulsAvgHome(dto.getFoulsAvgHome())
                .foulsAvgAway(dto.getFoulsAvgAway())
                .build();
    }
    ...
    public TeamRecentForm toTeamRecentForm(TeamDto dto) {
        ...
        return TeamRecentForm.builder()
                ...
                .cardsAvgHome(dto.getCardsAvgHome())
                .cardsAvgAway(dto.getCardsAvgAway())
                .scoredAvgOverall(dto.getScoredAvgOverall())
                .scoredAvgHome(dto.getScoredAvgHome())
                .scoredAvgAway(dto.getScoredAvgAway())
                .concededAvgOverall(dto.getConcededAvgOverall())
                .concededAvgHome(dto.getConcededAvgHome())
                .concededAvgAway(dto.getConcededAvgAway())
                .foulsAvgOverall(dto.getFoulsAvgOverall())
                .foulsAvgHome(dto.getFoulsAvgHome())
                .foulsAvgAway(dto.getFoulsAvgAway())
                .build();
